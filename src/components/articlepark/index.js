...
const Articlepark = ({ title, fact, info, maplink, imagecontentlinksection1, imagecontentlinksection2 }) => {
  return (
    <div>
        ...
        <div className={"cf"}>
          <div className={"fl pa3 pa4-ns bg-white black-70 measure-narrow f3 times mw7-l tc articlelefttext"}>
            <header className={"bb b--black-70 pv4"}>
              <h3 className={"f2 fw7 ttu tracked lh-title mt0 mb3 avenir"}>Los Quetzales</h3>
            ...
            <div className={"ph3 v-mid items-center "}>
      ...
      <article data-name="article-full-bleed-background">
        <div className={"cf fqwe"}>
          <div className={"fr pa3 pa4-ns bg-white black-70 measure-narrow f3 times mw7-l tc articlelefttext"}>
            <header className={"bb b--black-70 pv4"}>
              <h3 className={"f2 fw7 ttu tracked lh-title mt0 mb3 avenir"}>Los Quetzales2</h3>
              <h4 className={"f3 fw4 i lh-title mt0"}>Su origen data de 1984, cuando se le otorgó la categoría de Zona Protectora. Posteriormente, el 5 de junio de 2002 se declaró como Parque nacional La Cangreja.</h4>
            </header>
            <section className={"pt5 pb4"}>
              <p className={"times lh-copy  f4 mt0"}>
